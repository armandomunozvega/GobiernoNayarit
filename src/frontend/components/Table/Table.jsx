        ...
        <TableBody>
          {tableData.map((prop, key) => {
            ...
            return (
              ...
              >
                {prop.map((element, elementKey) => {
                  const tableCellClasses =
                    classes.tableCell +
                    " " +
                    cx({
                      [classes[colorsColls[coloredColls.indexOf(elementKey)]]]:
                        coloredColls.indexOf(elementKey) !== -1,
                      [customCellClasses[
                        customClassesForCells.indexOf(elementKey)
                      ]]: customClassesForCells.indexOf(elementKey) !== -1,
                    });
                  return (
                    <TableCell className={tableCellClasses} key={elementKey}>
                      {element}
                    </TableCell>
                  );
                })}
